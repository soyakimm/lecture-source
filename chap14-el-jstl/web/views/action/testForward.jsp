...
<body>
	...
	<jsp:setProperty property="age" name="member" value="25"/>
	<jsp:setProperty property="phone" name="member" value="010-0000-1111"/>
	<jsp:setProperty property="email" name="member" value="itswo@naver.com"/>
